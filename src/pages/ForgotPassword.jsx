        ...
        <div className="items-center">
          <form className="w-full md:w-[100%] lg:w-[100%] lg:ml-20 space-y-6 ">
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-sm space-x-4">
              ...
              <p>
                <Link to="/sign-in" className="text-blue-600 hover:text-blue-800 transition-duration-200 ease-in-out mb-6">Sign in instead?</Link>
              </p>
              </div>
              <div>
              <button type="submit" className="relative  w-full bg-blue-600 rounded-xl text-white px-7 py-3 justify center hover:bg-blue-800">Send reset password</button>
